...
ConnectionManager::setConfig('test_debug_kit', [
    ...
    'driver' => 'Cake\Database\Driver\Mysql',  // Use MySQL driver
    'host' => 'localhost',                     // The host of your MySQL server
    'username' => 'root',       // Your MySQL username
    'password' => 'root',       // Your MySQL password
    'database' => 'debug_kit_db',              // Your MySQL database name for DebugKit
    'encoding' => 'utf8mb4',                   // Encoding for MySQL
    'cacheMetadata' => true,                   // Cache metadata for performance
    'quoteIdentifiers' => false,               // Set this to false unless needed
